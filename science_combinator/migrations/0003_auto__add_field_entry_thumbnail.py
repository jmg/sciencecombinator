...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('science_combinator_entry', 'thumbnail',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('science_combinator_entry', 'thumbnail')
    ...
    models = {
        ...
        'science_combinator.entry': {
            ...
            'submited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 17, 0, 0)'}),
