...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AcceptedCategory'
        db.create_table('science_combinator_acceptedcategory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=300)),
        ))
        db.send_create_signal('science_combinator', ['AcceptedCategory'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'AcceptedCategory'
        db.delete_table('science_combinator_acceptedcategory')
    ...
    models = {
        ...
        'science_combinator.acceptedcategory': {
            'Meta': {'object_name': 'AcceptedCategory'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'science_combinator.config': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 23, 0, 0)'})
        },
        'science_combinator.entry': {
            ...
            'submited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 23, 0, 0)'}),
